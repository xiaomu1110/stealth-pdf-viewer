...
[![Version](https://img.shields.io/badge/Version-v1.5.6-success.svg)](https://github.com/xiaomu1110/stealth-pdf-viewer/releases)
...
### 方式 B：终端一键安装
```bash
code --install-extension stealth-pdf-viewer-1.5.6.vsix
```
